...
capture = VideoCapture('mauro_squat_webcam.mp4')
...
rep_counter = RepCounterOpticalFlow(
    ...
    min_nonzero_pixel_percentage=0.001,  # 0.0 to 100.0
...
output = CustomVideoWriter.from_video_capture(capture, file='mauro_squat_webcam_optical.mp4')
